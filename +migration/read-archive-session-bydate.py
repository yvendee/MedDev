...
def extract_data(pt, firstname, lastname, date):
    try:
...
# Example usage:
# data = extract_data(pt_value, firstname_value, lastname_value, date_value)
# Replace pt_value, firstname_value, lastname_value, and date_value with actual values
